...
use ocpp_client::ocpp_types::v21::common::{LogEnum, LogStatusEnum, UploadLogStatusEnum};
use ocpp_client::ocpp_types::v21::{GetLogRequest, GetLogResponse, LogStatusNotificationRequest};
...
mod tests {
    use super::*;
    use ocpp_client::ocpp_types::v21::common::LogParameters;
