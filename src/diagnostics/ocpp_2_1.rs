//! OCPP 2.1 wire adapter for the Diagnostics block's log upload (B5.1).
...
use crate::wire::v21::common::{LogEnum, LogStatusEnum, UploadLogStatusEnum};
use crate::wire::v21::{GetLogRequest, GetLogResponse, LogStatusNotificationRequest};
...
fn map_log_kind(log_type: &LogEnum) -> LogKind {
    match log_type {
        ...
        LogEnum::DataCollectorLog => LogKind::DataCollector,
...
/// Wraps an [`OCPP2_1Client`] with the [`Clock`] the handler needs to name a log file.
pub struct Ocpp2_1DiagnosticsHandler<C> {
    client: OCPP2_1Client,
    clock: C,
}

impl<C: Clock + Clone + Send + Sync + 'static> Ocpp2_1DiagnosticsHandler<C> {
...
#[cfg(feature = "std")]
impl Ocpp2_1DiagnosticsHandler<crate::clock::SystemClock> {
...
impl<C: Clock + Clone + Send + Sync + 'static> GetLogHandler for Ocpp2_1DiagnosticsHandler<C> {
...
#[async_trait::async_trait]
impl<C: Clock + Clone + Send + Sync + 'static> LogStatusNotifier for Ocpp2_1DiagnosticsHandler<C> {
...
mod std_impls {
    ...
    #[async_trait::async_trait]
    impl GetLogHandler for OCPP2_1Client {
        async fn register_get_log_handler(
            &self,
            actor: ChargePointActor,
            uploads: LogUploadQueue,
            ...
            Ocpp2_1DiagnosticsHandler::new(self.clone())
    ...
    #[async_trait::async_trait]
    impl LogStatusNotifier for OCPP2_1Client {
        type Error = ocpp_client::ClientError<ocpp_client::ocpp_2_1::OCPP2_1Error>;
...
mod tests {
    use super::*;
    use crate::wire::v21::common::LogParameters;
    ...
    fn wire_request(log_type: LogEnum) -> GetLogRequest {
        GetLogRequest {
            ...
            log: LogParameters {
                ...
                remote_location: "https://logs.example/up".into(),
            },
            log_type,
            request_id: 42,
            retries: Some(3),
    ...
    fn every_log_type_maps_onto_this_crates_kinds() {
        ...
        assert_eq!(
            map_log_kind(&LogEnum::DataCollectorLog),
            LogKind::DataCollector
        );
    }
