...
/// 2.1's `UpdateFirmware` already carries `signature`/`signingCertificate` inline - there is no
/// separate `SignedUpdateFirmware` action to register here. See the trait's docs.
impl SignedUpdateFirmwareHandler for Ocpp2_1FirmwareHandler {}
...
mod std_impls {
    ...
    impl SignedUpdateFirmwareHandler for OCPP2_1Client {}
