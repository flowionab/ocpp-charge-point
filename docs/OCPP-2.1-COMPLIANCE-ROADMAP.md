...
Status: **in progress** — K, E, C, N and Q swept at requirement level (2026-08-12/13); **CV12.7
(I, L, M, O, P, G, H, J, S — 349 FRs across nine blocks) is the one sweep still outstanding.**
...
| **CV12.7** | **I, L, M, O, P, G, H, J, S** (349 combined) — untouched. The largest remaining piece of the workstream, and the only sweep left. Worth splitting per block rather than taken as one row: I (tariff/cost) and G (availability) are the two whose mechanisms this crate implements most heavily, so they have the most to verify; O, P and S are small. | open |
